export const letter = {
  ...
  paragraphs: [
    ...
    [
      { t: "Прости, если письмо неидеальное. Это первое письмо, которое я написал в своей жизни, и я рад, что пишу его тебе. Пусть оно будет не " },
      { t: "τελευταίο", reveal: "последним" },
      { t: " :)" },
    ],
